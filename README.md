# hms
Hierarchy geo-based micro-services to overcome challenges of tracking-searching problem
...
3. Solutions: 
  * Hierarchy geo-based sharding by Mongodb
  * Hierarchy geo-based sharding by Micro-services (memory storage)
